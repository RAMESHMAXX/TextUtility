    ...
    return (
        <nav className={`navbar navbar-expand-md bg-${props.mode} navbar-${props.mode}`}>
            <div className="container-fluid">
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li className="nav-item">
                            <NavLink className="nav-link" to="/aboutUs">{props.about}</NavLink>
                        </li>
            ...
            <div className="form-check form-switch">
                ...
                <label className={`form-check-label text-${props.mode==='light' ? 'dark':'light'}`} htmlFor="flexSwitchCheckDefault" >{props.toggleText}</label>
            </div>
        </nav>
    );
